...
export default function SentimentRecognition() {
  return (
    <div className="page">
      <Row single>
        <Block>
          <p>Text Block 111 Text Block 111 Text Block 111 Text Block 111 Text Block 111 
          Text Block 111  Text Block 111 Text Block 111 Text Block 111  </p>
        </Block>  
      </Row>
      <Row>
